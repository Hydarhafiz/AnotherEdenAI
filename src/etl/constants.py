...
ETL_ALLOW_SUPERBOSS_RECONCILIATION = _env_flag("ETL_ALLOW_SUPERBOSS_RECONCILIATION", False)
...
EXPECTED_NODE_COUNTS = {
    ...
    "Grasta": 600,     # exact variants remain distinct instead of collapsing by display name
    "Ore": 50,         # wiki has 61
    "Trait": 10,
}
