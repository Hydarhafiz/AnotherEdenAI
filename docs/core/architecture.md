...
- Repository tooling deterministically exports stratified 45-row CSV review batches and targeted migration-review artifacts plus constrained allowed-value and field-guidance references; imports tolerate common spreadsheet encodings and safe correction aliases while rejecting incomplete, invalid, drifted, superseded, or evidence-edited rows.
